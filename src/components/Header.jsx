...
useEffect(() => {
  const token = sessionStorage.getItem("token");  // <-- yahan localStorage ki jagah sessionStorage karo
  ...
  return (
    <div style={{ justifyContent: "space-between", display: "flex" }}>
      ...
      >
        ...
        {/* Agar user logged in hai toh login/signup nahi dikhana */}
        {!isLoggedIn ? (
          <>
      ...
      >
        {/* Agar logged in ho aur profile picture hai toh dikhao, nahi toh user icon */}
